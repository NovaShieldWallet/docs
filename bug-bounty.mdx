---
title: 'Security Disclosure & Bug Bounty'
description: 'Scoped bug bounty program for Nova multisig security vulnerabilities.'
---

# Security Disclosure & Bug Bounty

Nova welcomes responsible disclosure of security vulnerabilities that directly impact **Nova multisig security**. This program is intentionally narrow in scope and is designed to focus only on issues that can affect multisig approvals and transaction safety.
...
| On-chain multisig program behavior (Nova usage)  | Vulnerabilities in the on-chain multisig program **as configured and used by Nova** that can lead to unauthorized transactions or incorrect execution semantics.   |
